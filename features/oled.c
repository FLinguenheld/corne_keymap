...
void oled_display(void) {
    ...
    oled_write_P(PSTR("\n\n"), false);
        ...
        switch (get_highest_layer(layer_state)) {
            ...
            case _RAISE:
            case _US_RAISE:
                static const char PROGMEM qmk_raise[] = {
            ...
            case _US_ADJUST:
                static const char PROGMEM qmk_adjust[] = {
                    0x09, 0x20, 0x20, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C, 0x4D, 0x4E, 0x20, 0x20, 0x09, 0x00,
                };
            ...
            case _US_FN:
                static const char PROGMEM qmk_fn[] = {
                    0x20, 0x20, 0x20, 0x09, 0x20, 0x09, 0x20, 0x20, 0x4F, 0x50, 0x20, 0x51, 0x52, 0x20, 0x20, 0x09, 0x20, 0x09, 0x20, 0x20, 0x20, 0x00,
                };
